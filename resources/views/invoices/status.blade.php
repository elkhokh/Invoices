...
@section('content')->
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    {{-- <form action="{{ route('invoices.updateStatus', ['id' => $invoices->id]) }}" method="POST" autocomplete="off"> --}}
                    <form action="{{ route('invoices.updateStatus', $invoices->id) }}" method="POST">
                        @csrf
                        @method('PATCh')
                        {{-- 1 --}}
                        <div class="row">
        ...
        <option value="مدفوعة جزئيا" {{ old('status') == 'مدفوعة جزئيا' ? 'selected' : '' }}>مدفوعة جزئيا</option> --}}
