...
@section('content')
    {{-- تحقّق بسيط (عادة findOrFail يضمن وجود الفاتورة) --}}
    @if (!isset($invoices))
                                                ...
                                                <table class="table table-striped" style="text-align:center">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>{{ optional($invoices->section ?? $invoices->Section)->section_name ?? '-' }}</td>
                                                        </tr>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @forelse ($details as $x)
                                                            <tr>
                                                                ...
                                                                <td>{{ $x->note ?? '-' }}</td>
                                                                <td>{{ $x->created_at ? $x->created_at->format('Y-m-d H:i') : '-' }}</td>
                                                                <td>{{ $x->user ?? '-' }}</td>
                                                            </tr>
                                                        @empty
                                                            <tr>
                                                                <td colspan="9" class="text-center">لا توجد حالات دفع/تفاصيل</td>
                                                            </tr>
                                                        @endforelse
                                                    </tbody>
                                                </table>
...
@section('js')
    ...
    <script>
        // show selected file name on custom input
