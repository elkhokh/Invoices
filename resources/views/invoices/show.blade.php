        ...
        <div class="col-xl-12">
            ...
            <div class="card mg-b-20" id="tabs-style2">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            @if ($invoices->value_status == 1)
                                                                <td><span
                                                                        class="badge badge-pill badge-success">{{ $invoices->value_status }}</span>
                                                                </td>
                ...
                <button type="submit" class="btn btn-primary btn-sm " name="uploadedFile">تاكيد</button>
                            ...
                            src="{{ asset('storage/invoices_file/' . $attachment?->file_name) }}"
                                                alt="المرفق">
                                            </td> --}}
                ...
                <div class="modal-dialog" role="document">
                    <form action="{{ route('attachment.destroy', $attachment->id) }}" method="POST">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                            <p>هل أنت متأكد من حذف المنتج: <strong>{{ $attachment->file_name }}</strong>؟</p>
                            </div>
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-danger">حذف</button>
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">إلغاء</button>
    ...
    {{-- <div class="modal fade" id="detail" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('detail.destroy') }}" method="POST">
                @csrf
                @method('DELETE')
                    <div class="modal-body">
                        <p class="text-center">
