...
<div class="main-header sticky side-header nav nav-item">
                ...
                <li class="">
                    <div class="dropdown  nav-itemd-none d-md-flex">
                        <a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown"
                            ...
                            <img src="{{ URL::asset('assets/img/flags/egypt_flag.png') }}" alt="Egypt Flag"></span>
                            <div class="my-auto">
    ...
    <span class="avatar ml-3 align-self-center bg-transparent">
        <img src="{{ URL::asset('assets/img/flags/egypt_flag.png') }}" alt="Egypt Flag">
    </span>
    <div class="d-flex">
        <span class="mt-2">Egypt</span>
    </div>
</a>
                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                ...
                                <a href="{{ route('markedAll') }}" class="badge badge-pill badge-warning mr-auto my-auto">تحديد الكل
                                    كمقروء</a>
                            </div>
